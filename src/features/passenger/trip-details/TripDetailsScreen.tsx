    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
          ...
          <View style={styles.routeContainer}>
            ...
            <View style={styles.routeInfo}>
              <View style={styles.locationBlock}>
                <Text style={styles.time}>06:30 PM</Text>
                <Text style={styles.location}>Hyderabad</Text>
                <Text style={styles.pickupDetail}>Gachibowli Outer Ring Road / IKEA Junction</Text>
              </View>

              <View style={styles.durationPill}>
                <Text style={styles.durationText}>⚡ 5h 30m non-stop express</Text>
              </View>

              <View style={styles.locationBlock}>
                <Text style={styles.time}>12:00 AM</Text>
                <Text style={styles.location}>Bengaluru</Text>
                <Text style={styles.pickupDetail}>Silk Board / Electronic City Flyover Drop</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.driverBioBox}>
            <Text style={styles.driverBio}>
              {'"Tech professional commuting weekly between Hyderabad and Bengaluru. Very clean EV, smooth drive, good music!"'}
            </Text>
          </View>
        </View>
      ...
      <View style={styles.footerContainer}>
        <View style={styles.footerPriceCol}>
          <Text style={styles.footerPrice}>₹650</Text>
